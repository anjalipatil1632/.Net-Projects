...
using EmployeeTravelBookingSystem_WebApi;

namespace EmployeeTravelBookingSystem_WebApi.Controllers
{
    public class TravelController : ApiController
    {
        EmpTravelBookingSystemEntities dbEntities = new EmpTravelBookingSystemEntities();
        [HttpGet]
        ...
        {
            var insertresults = dbEntities.AddEmployee(user.LoginId, user.Password, user.Name);
